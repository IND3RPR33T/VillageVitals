      ...
      `;
        ...
        return (
            <div
                ...
                style={{ ...style, position: 'relative', overflow: 'hidden', '--glow-color': glowColor, background: gradientColor ? `linear-gradient(to bottom right, ${gradientColor}, transparent)` : style?.background } as React.CSSProperties}
            >
...
export const MagicBentoGrid: React.FC<{
    ...
    spotlightRadius?: number;
    glowColor?: string;
}> = ({ children, className, spotlightRadius = DEFAULT_SPOTLIGHT_RADIUS, glowColor = DEFAULT_GLOW_COLOR }) => {
    const gridRef = useRef<HTMLDivElement>(null);
    return (
        <div className={`card-grid bento-section ${className || ''}`} ref={gridRef as React.RefObject<HTMLDivElement>}>
            <GlobalSpotlight
                gridRef={gridRef}
